...
func (g *golangPatcher) Patch(podSpec *v1.PodTemplateSpec, instrumentation *apiv1.InstrumentedApplication) {
...
func (g *golangPatcher) IsInstrumented(podSpec *v1.PodTemplateSpec, instrumentation *apiv1.InstrumentedApplication) bool {
